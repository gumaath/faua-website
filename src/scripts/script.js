...
function validarFormVoluntario() {
    if ($('#FormVolunteer').validate({
        ...
        if ($('#FormVolunteer').valid()) {
            var clickBtnValue = 'cadastrarVoluntario';
            var ajaxurl = '../src/php/Ajax.php';
            var data = {
                'action': clickBtnValue,
                'nomeVolunteer': $('#FormVolunteer #formNomeVolunteer').val(),
                'emailVolunteer': $('#FormVolunteer #formEmailVolunteer').val(),
                'passVolunteer': $('#FormVolunteer #formPassVolunteer').val(),
                'cpfVolunteer': $('#FormVolunteer #formCPFVolunteer').val(),
                'rgVolunteer': $('#FormVolunteer #formRGVolunteer').val(),
                'telVolunteer': $('#FormVolunteer #formTelVolunteer').val(),
                'endVolunteer': $('#FormVolunteer #formEndVolunteer').val(),                
                'estadoVolunteer': $('#FormVolunteer #estados :selected').val(),
                'cidadeVolunteer': $('#FormVolunteer #cidades :selected').val(),
                'sangueVolunteer': $('#FormVolunteer #letra-sangue :selected').val(),
                'tipoVolunteer': $('#FormVolunteer #tipo-sangue :selected').val(),
                'nascVolunteer': $('#FormVolunteer #startDate').val()
            }

            $.post(ajaxurl, data, function (response) {
                window.location.replace('./src/views/success-volunteer-submit.php');
            });
        }
    };
};
        ...
        $('#botaoInstituicao_' + idInstitute).click(function () {
            if ($('#FormInstituteEdit_' + idInstitute).valid()) {
                ...
                var data = {
                    ...
                    'formEmailInstitute': $('#FormInstituteEdit_' + idInstitute + ' #formEmailInstitute').val(),
                    ...
                    'formEmailInstitute': $('#FormInstituteEdit_' + idInstitute + ' #formEmailInstitute').val(),
                    'descricaoInstitute': $('#FormInstituteEdit_' + idInstitute + ' #formDescriInstitute').val()
                }
...
function validarFormInstituicaoNovo() {
    if ($('#FormInstitute').validate({
        ...
        $('#botaoInstituicaoForm').click(function () {
            if ($('#FormInstitute').valid()) {
                var clickBtnValue = 'adicionarInstituicaoForm';
                ...
                var data = {
                    ...
                    'formNomeInstitute': $('#FormInstitute #formNomeInstitute').val(),
                    'formRespInstitute': $('#FormInstitute #formRespInstitute').val(),
                    'formEmailInstitute': $('#FormInstitute #formEmailInstitute').val(),
                    'formCNPJCPFInstituter': $('#FormInstitute #formCNPJCPFInstitute').val(),
                    'formEndInstitute': $('#FormInstitute #formEndInstitute').val(),
                    'tipoinstituicao': $('#FormInstitute .type-item-box:selected').val(),
                    'cidadeInstitute': $('#FormInstitute .cidades').val(),
