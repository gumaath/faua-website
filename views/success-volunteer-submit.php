...
<head>
    ...
    <title>Seu formulário foi enviado!</title>
...
<body>
    ...
    <div id="main-content">
        <div class="container">
            ...
            <h1 class="title">Formulário enviado com sucesso!</h1>
            <h3 class="title">Seu formulário agora estará em análise e você receberá um e-mail quando for aprovado!</h1>
        </div>
